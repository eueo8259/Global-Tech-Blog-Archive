CREATE TABLE slack_deliveries (
    ...
    PRIMARY KEY (id),
    CONSTRAINT uq_slack_deliveries_channel_date_type
        UNIQUE (slack_channel_id, delivery_date, delivery_type),
    ...
    INDEX idx_slack_deliveries_channel_sent_window
        (slack_channel_id, delivery_type, status, window_ended_at)
